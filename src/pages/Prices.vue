<template>
    ...
    <div class="container">
      <div class="row text-center">
        <div class="col-md-12">
          <div class="">
            <h1>Pricing</h1>
            <p>Your virtual photo studio without pricing tag</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          <p>Photo edit center offer them to use us as their own photo editing studio with very low pricing for all kinds of services like clipping path service, image masking, photo retouching, shadow services, neck joint service, raster to vector, color correction, and other image editing services.</p>
        </div>
      </div>
    </div>
  </section>
  <section class="price_detail_area">
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center">
          <h2>Clipping Path Price</h2>
        </div>
      </div>
      <div class="row service-price-box">
        <div class="col-md-2">
      ...
      <div class="row text-center  ">
        <div class="col-md-12">
          <div class="link p-50"><a href="" class="btn">Get Quote</a></div>
        </div>
      </div>
    </div>
  </section>
  <section class="price_detail_area price_detail_area_even">
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center">
  ...
  <section class="price_detail_area ">
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center">
          <h2>E-Commerce Photo Editing</h2>
        </div>
      </div>
      <div class="row service-price-box">
        <div class="col-md-2">
  ...
  <section class="payment_status_area ">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2 class="text-center">Payment Methods We accept</h2>
          <p><span>“Photo Edit center”</span> has unique options for their consumers who need to pay for the services requested. The consumer simply fills out a form providing the contact name, company info with full address and call number. After a batch of work is finished, an invoice is sent to the customer. The customer will have to pay by PayPal, Credits or Debit Cards, and Wire/Bank Transfer. The invoice that’s sent by <span>“Photo Edit Center</span>” is easy and contains all the information necessary for making the payment.</p>
        </div>
      </div>
    </div>
  </section>
  <section class="price_message_area">
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <div class="link p-20"><a href="" class="btn">Get Quote</a></div>
        </div>
      </div>
    </div>
  </section>
...
.individual_banner {
  ...
  background: rgb(205 233 251);
}
.individual_banner h1 {
    font-size: 48px;
    line-height: 72px;
    color: #2b1b9a;
    font-weight: 600;
...
.price_detail_area_even{
  background: #f0eefd;
}



.price_detail_area h2{
  font-size: 30px;
  line-height: 35px;
  font-weight: 600;
  color: #2b1b9a;
...
.service-price-box {
  padding: 50px 40px;
  background: #ffff;
  border-top: 10px solid rgb(103 182 244 / 30%);
}
...
.service-price-box table tr{
  margin: 10px;
}

.service-price-box table tr td{
  background: #ededed;
  padding: 5px 8px;
  color: #2b1b9a;
  font-size: 16px;
...
.service-price-box table tr td.price{
  font-weight: 600;
}
...
.payment_status_area p{
  font-size: 16px;
  font-weight: 400;
  line-height: 26px;
  color: #2b1b9a;
}
.payment_status_area p span{
  font-weight: 700;
  color: #2b1b9a;
}
